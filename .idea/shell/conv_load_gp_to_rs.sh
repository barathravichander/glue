#!/bin/sh
#####################################################################
# Script:    conv_load_gp_to_rs.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   23-Mar-2023
# Developer: Rajalakshmi Rajagopal
#
# Usage:   conv_load_gp_to_rs.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2023/02/06 : Rajalakshmi Rajagopal : Initial Veersion
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_load_gp_to_rs"
...
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, TABLE_NAME=${TABLE_NAME} , AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--TABLE_NAME=\"$TABLE_NAME\""
