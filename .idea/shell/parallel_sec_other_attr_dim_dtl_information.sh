#!/bin/sh
#####################################################################
# Script:    parallel_sec_other_attr_dim_dtl_information.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   23-FEB-2022
# Developer: Rajalakshmi Rajagopal
#
# Usage:   parallel_sec_other_attr_dim_dtl_information.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_sec_other_attr_dim_dtl_information"
