#!/bin/sh
#####################################################################
# Script:  tdr_stub_sleeve_brdg_account_relation.sh
# Project: Unicorn - AWS Glue Migration
# Created: 23-JUL-2021
# Developer: Akhil Joe
#
# Usage:   tdr_stub_sleeve_brdg_account_relation.sh date environment AWS region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="tdr_stub_sleeve_brdg_account_relation"
