#!/bin/sh
#####################################################################
# Script:    foa_program_mf_benchmark_association.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   02-July-2020
# Developer: Vikas Singh
#
# Usage:   foa_program_mf_benchmark_association.sh date environment aws-region
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="foa_program_mf_benchmark_association"
