#!/bin/sh
#####################################################################
# Script:    delta_account_target_ben_association.sh
# Project:   Unicorn - AWS Glue Enhancement
# Created:   17-Sep-2021
# Developer: Vasudevan
#
# Usage:   delta_account_target_ben_association.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="delta_account_target_ben_association"
