#!/bin/sh
#####################################################################
# Script:  caps_fact_class_entity.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   caps_fact_class_entity.sh date environment
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#	  2019/11/18 : kumarsuni : updated for logging framework : NA (Enhancement)
#                              updated Job Args for Glue Job
#   2022/06/16 : Uday V   : Updated instrument stub args by a flag Y or N: NA (Enhancement)
#                              updated Job Args for Glue Job
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="caps_fact_class_entity"
...
g_MSG="Required number of Arguments: ${REQRD_ARGUMENT_COUNT} and Not ${NUM_ARG} to ${RUN_SCRIPT} \\
      USAGE:   ${RUN_SCRIPT} batch-date environment instrument_stub aws-region \\
      EXAMPLE: ${RUN_SCRIPT} YYYY-MM-DD dev Y or N us-east-1 \\
...
INSTRUMENT_STUB=$3
AWS_REGION=$4
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, INSTRUMENT_STUB=${INSTRUMENT_STUB}, AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--INSTRUMENT_STUB=\"$INSTRUMENT_STUB\""
