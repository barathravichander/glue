#!/bin/sh
#####################################################################
# Script:    parallel_ai_fact_mv_multiplier.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   10-22-2020
# Developer: Amit Kheterpal
#
# Usage:   ai_fact_mv_multiplier.sh date environment aws-region client_number
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_ai_fact_mv_multiplier"
...
g_MSG="Required number of Arguments: ${REQRD_ARGUMENT_COUNT} and Not ${NUM_ARG} to ${RUN_SCRIPT} \\
      ...
      EXAMPLE: ${RUN_SCRIPT} YYYY-MM-DD dev 0003 us-east-1 \\
...
CLIENT_NUMBER=$3
AWS_REGION=$4
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, CLIENT_NUMBER=${CLIENT_NUMBER}, AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--CLIENT_NUMBER=\"$CLIENT_NUMBER\""
