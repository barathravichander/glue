#!/bin/sh
#####################################################################
# Script:    conv_ben_daily_fact_benchmark_ror.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   01-Apr-2020
# Developer: Sanjay Pancholi
#
# Usage:   conv_ben_daily_fact_benchmark_ror.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_ben_daily_fact_benchmark_ror"
