#!/bin/sh
#####################################################################
# Script:    sec_other_attr_dim_dtl_information.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   19-June-2020
# Developer: Chirag Mota
#
# Usage:   conv_sec_other_attr_dim_dtl_information.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="sec_other_attr_dim_dtl_information"
