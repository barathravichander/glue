#!/bin/sh
#####################################################################
# Script:    conv_pfolval_fact_holding.sh
# Project:   Unicorn - AWS Glue Conversion
# Created:   24-Oct-2019
# Developer: Sanjay Pancholi
#
# Usage:   conv_pfolval_fact_holding.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/12/04 : pancholis : enhanced for usage of common.lib : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_pfolval_fact_holding"
