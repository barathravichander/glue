#!/bin/sh
#####################################################################
# Script:    annuities_fact_transaction.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   annuities_fact_transaction.sh date environment aws-region batch_type
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="annuities_fact_transaction"
...
AWS_REGION=$3
BATCH_TYPE=$4
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, AWS_REGION=${AWS_REGION}, BATCH_TYPE=${BATCH_TYPE}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--BATCH_TYPE=\"$BATCH_TYPE\""
