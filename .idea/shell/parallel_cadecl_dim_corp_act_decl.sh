#!/bin/sh
#####################################################################
# Script:    parallel_cadecl_dim_corp_act_decl.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   29-June-2021
# Developer: Praneeth 
#
# Usage:   parallel_cadecl_dim_corp_act_decl.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_cadecl_dim_corp_act_decl"
