#!/bin/sh
#####################################################################
# Script:    manual_asset_balance_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   18-Jam-2020
# Developer: Vikas Singh
#
# Usage:   manual_asset_balance_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="manual_asset_balance_fact_assets_liabilities"
