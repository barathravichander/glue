#!/bin/sh
#####################################################################
# Script:    fnd_mrgr_kill_keep_brdg_instrument_relation.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   28-Mar-2020
# Developer: Akshay Gundale
#
# Usage:   fnd_mrgr_kill_keep_brdg_instrument_relation.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/03/28 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="fnd_mrgr_kill_keep_brdg_instrument_relation"
