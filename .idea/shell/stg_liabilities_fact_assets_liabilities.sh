#!/bin/sh
#####################################################################
# Script:    stg_liabilities_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   24-Dec-2020
# Developer: Vikas Singh
#
# Usage:   stg_liabilities_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="stg_liabilities_fact_assets_liabilities"
