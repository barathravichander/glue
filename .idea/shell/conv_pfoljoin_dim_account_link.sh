#!/bin/sh
#####################################################################
# Script:    conv_pfoljoin_dim_account_link.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   07-Jan-2020
# Developer: Akshay Gundale
#
# Usage:   conv_pfoljoin_dim_account_link.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/01/09 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_pfoljoin_dim_account_link"
