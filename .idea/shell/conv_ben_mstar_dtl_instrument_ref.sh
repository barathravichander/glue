#!/bin/sh
#####################################################################
# Script:    conv_ben_mstar_dtl_instrument_ref.sh
# Project:   Unicorn - AWS Glue Conversion
# Created:   06-Apr-2020
# Developer: Saubhagya Baral
#
# Usage:   conv_ben_mstar_dtl_instrument_ref.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_ben_mstar_dtl_instrument_ref"
