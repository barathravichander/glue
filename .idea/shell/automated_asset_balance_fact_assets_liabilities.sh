#!/bin/sh
#####################################################################
# Script:    automated_asset_balance_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   11-Dec-2020
# Developer: Vikas Singh
#
# Usage:   automated_asset_balance_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="automated_asset_balance_fact_assets_liabilities"
