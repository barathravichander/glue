#!/bin/sh
#####################################################################
# Script:  msl_stg_underlying_sec_info.sh
# Project: Unicorn - AWS Glue Migration
# Created: 20-Nov-2019
# Developer: Obulam
#
# Usage:   msl_stg_underlying_sec_info.sh date env record_type client_number aws_region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/11/20 : Obulam Reddy     :  Added AWS_REGION argument
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="msl_stg_underlying_sec_info"
