...
#
# Usage:   ui_sync_fact_position_values.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="ui_sync_fact_position_values_p"
...
ENV=$3
AWS_REGION=$4
g_MSG="TABLE_NAME=${TABLE_NAME}, ACCOUNT_ID=${ACCOUNT_ID}, ENV=${ENV}, AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--ACCOUNT_ID=\"$ACCOUNT_ID\",--TABLE_NAME=\"$TABLE_NAME\""
