#!/bin/sh
#####################################################################
# Script:    conv_stub_insu_position_instrument_ref.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   09-Dec-2020
# Developer: Chirag Mota
#
# Usage:   conv_stub_insu_position_instrument_ref.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_stub_insu_position_instrument_ref"
