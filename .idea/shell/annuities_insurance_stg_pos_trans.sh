#!/bin/sh
#####################################################################
# Script:    annuities_insurance_stg_pos_trans.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   24-Sep-2020
# Developer: Chirag Mota
#
# Usage:   annuities_insurance_stg_pos_trans.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="annuities_insurance_stg_pos_trans"
