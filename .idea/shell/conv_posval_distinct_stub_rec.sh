#!/bin/sh
#####################################################################
# Script:    conv_posval_distinct_stub_rec.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   conv_posval_distinct_stub_rec.sh date environment year aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_posval_distinct_stub_rec"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--YEAR=\"$YEAR\""
