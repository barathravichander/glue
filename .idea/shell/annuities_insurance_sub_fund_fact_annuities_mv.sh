#!/bin/sh
#####################################################################
# Script:    annuities_insurance_sub_fund_fact_annuities_mv.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   07-Dec-2020
# Developer: Vikas Singh
#
# Usage:   annuities_insurance_sub_fund_fact_annuities_mv.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="annuities_insurance_sub_fund_fact_annuities_mv"
