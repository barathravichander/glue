#!/bin/sh
#####################################################################
# Script:  prospectus_ben_brdg_instrument_relation.sh
# Project: Unicorn - AWS Glue Migration
# Created: 20-04-2020
# Developer: Sunil Kumar
#
# Usage:   prospectus_ben_brdg_instrument_relation.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="prospectus_ben_brdg_instrument_relation"
