#!/bin/sh
#####################################################################
# Script:    annuities_stg_stub_fact_sor_holding.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   annuities_stg_stub_fact_sor_holding.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="annuities_stg_stub_fact_sor_holding"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--ACCOUNT_STUB=\"$ACCOUNT_STUB\",--INSTRUMENT_STUB=\"$INSTRUMENT_STUB\""
