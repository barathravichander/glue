#!/bin/sh
#####################################################################
# Script:    conv_composite_stub.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   17-Mar-2020
# Developer: Akshay Gundale
#
# Usage:   conv_composite_stub.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/03/17 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_composite_stub"
