#!/bin/sh
#####################################################################
# Script:    manual_liabilities_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   11-Dec-2020
# Developer: Vikas Singh
#
# Usage:   manual_liabilities_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="manual_liabilities_fact_assets_liabilities"
