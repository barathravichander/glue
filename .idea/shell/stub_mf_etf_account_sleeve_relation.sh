#!/bin/sh
#####################################################################
# Script:    stub_mf_etf_account_sleeve_relation.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   05-Nov-2020
# Developer: Vikas Singh
#
# Usage:   stub_mf_etf_account_sleeve_relation.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="stub_mf_etf_account_sleeve_relation"
