#!/bin/sh
#####################################################################
# Script:  conv_fischd_fihist_fact_price_haf.sh
# Project: Unicorn - AWS Glue Migration
# Created: 20-Aug-2021
# Developer: Haribabu Ponnaganti
#
# Usage:   conv_fischd_fihist_fact_price_haf.sh date environment aws-region
#####################################################################

#Script/job name:
JOB_NAME="conv_fischd_fihist_fact_price_haf"
