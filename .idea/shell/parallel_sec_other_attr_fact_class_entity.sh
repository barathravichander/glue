#!/bin/sh
#####################################################################
# Script:  parallel_sec_other_attr_fact_class_entity.sh
# Project: Unicorn - AWS Glue Migration
# Created: 28-FEB-2022
# Developer: Rajalakshmi Rajagopal
#
# Usage:   parallel_sec_other_attr_fact_class_entity.sh date environment AWS region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_sec_other_attr_fact_class_entity"
