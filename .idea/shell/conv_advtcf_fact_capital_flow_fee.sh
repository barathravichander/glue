#!/bin/sh
#####################################################################
# Script:  conv_advtcf_fact_capital_flow_fee.sh
# Project: Unicorn - AWS Glue Migration
# Created: 26-Jul-2021
# Developer: Uday V
#
# Usage:   conv_advtcf_fact_capital_flow_fee.sh date environment aws-region
#
#================================================================
#  Change Revision
#================================================================
...
#Script/job name:
JOB_NAME="conv_advtcf_fact_capital_flow_fee"
