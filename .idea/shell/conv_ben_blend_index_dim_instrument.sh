!/bin/sh
#####################################################################
# Script:    conv_ben_blend_index_dim_instrument.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   31-Mar-2020
# Developer: Vikas Singh
#
# Usage:   conv_ben_blend_index_dim_instrument.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/04/02 : singhvi : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_ben_blend_index_dim_instrument"
