#!/bin/sh
#####################################################################
# Script:  conv_cashflow_delta_fact_capital_flow_fee.sh
# Project: Unicorn - AWS Glue Migration
# Created: 04-Feb-2022
# Developer: Akhil Joe
#
# Usage:   conv_cashflow_delta_fact_capital_flow_fee.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_cashflow_delta_fact_capital_flow_fee"
