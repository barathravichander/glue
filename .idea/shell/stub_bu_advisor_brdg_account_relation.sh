#!/bin/sh
#####################################################################
# Script:  stub_bu_advisor_brdg_account_relation.sh
# Project: Unicorn - AWS Glue Migration
# Created: 15-Feb-2022
# Developer: Vasudevan
#
# Usage:   stub_bu_advisor_brdg_account_relation.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="stub_bu_advisor_brdg_account_relation"
