#!/bin/sh
#####################################################################
# Script:    automated_liability_balance_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   15-Dec-2020
# Developer: Vikas Singh
#
# Usage:   automated_liability_balance_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="automated_liability_balance_fact_assets_liabilities"
