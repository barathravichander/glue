#!/bin/sh
#####################################################################
# Script:  day_zero_annuities_fact_holding.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   day_zero_annuities_fact_holding.sh date environment
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/11/20 : Obulam Reddy : updated for logging framework : NA (Enhancement)
#                              updated Job Args for Glue Job
#     2021/10/07 : Uday V : updated account and instrumented stub args : NA (Enhancement)
#                              updated Job Args for Glue Job
#     2022/08/17 : Vasudevan P : Added a parameter to conf to fix date pattern issue occurred at Glue 3.0 : Bug no
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="day_zero_annuities_fact_holding"
...
g_MSG="Required number of Arguments: ${REQRD_ARGUMENT_COUNT} and Not ${NUM_ARG} to ${RUN_SCRIPT} \\
      USAGE:   ${RUN_SCRIPT} batch-date environment account_stub instrument_stub aws-region \\
...
INSTRUMENT_STUB=$4
AWS_REGION=$5
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, ACCOUNT_STUB=${ACCOUNT_STUB}, INSTRUMENT_STUB=${INSTRUMENT_STUB}, AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
CONFIG_SPARK_MEM='spark.sql.legacy.timeParserPolicy=LEGACY'
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--ACCOUNT_STUB=\"$ACCOUNT_STUB\",--INSTRUMENT_STUB=\"$INSTRUMENT_STUB\",--conf=\"$CONFIG_SPARK_MEM\""
