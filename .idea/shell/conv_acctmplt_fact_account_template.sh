#!/bin/sh
#####################################################################
# Script:    conv_acctmplt_fact_account_template.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   11-Dec-2020
# Developer: Chirag Mota
#
# Usage:   conv_acctmplt_fact_account_template.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_acctmplt_fact_account_template"
