#!/bin/sh
#####################################################################
# Script:  h2b_fact_transaction.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   h2b_fact_transaction.sh date environment
#
#================================================================
#  Change Revision
...
g_MSG="Required number of Arguments: ${REQRD_ARGUMENT_COUNT} and Not ${NUM_ARG} to ${RUN_SCRIPT} \\
      USAGE:   ${RUN_SCRIPT} batch-date environment source_system_nm aws-region \\
