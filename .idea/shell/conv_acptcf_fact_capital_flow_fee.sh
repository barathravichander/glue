#!/bin/sh
#####################################################################
# Script:    conv_acptcf_fact_capital_flow_fee.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   10-Dec-2019
# Developer: Chirag Mota
#
# Usage:   conv_acptcf_fact_capital_flow_fee.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_acptcf_fact_capital_flow_fee"
