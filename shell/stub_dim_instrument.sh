#!/bin/sh
#####################################################################
# Script:  stub_dim_instrument.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   stub_dim_instrument.sh date environment
#
#================================================================
#  Change Revision
...
#         2021/09/28 : Akhil JOe    : updated instrumented stub args : NA (Enhancement)
#                                  updated Job Args for Glue Job
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="stub_dim_instrument"
...
g_MSG="Required number of Arguments: ${REQRD_ARGUMENT_COUNT} and Not ${NUM_ARG} to ${RUN_SCRIPT} \\
      ...
      EXAMPLE: ${RUN_SCRIPT} YYYY-MM-DD dev Y us-east-1 \\
