#!/bin/sh
#####################################################################
# Script:    automated_holdings_details_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   17-Dec-2020
# Developer: UDAY V
#
# Usage:   automated_holdings_details_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="automated_holdings_details_fact_assets_liabilities"
