#!/bin/sh
###############################################################################
# Script:    carma_option_overlay_fact_capital_flow_fee.sh
# Project:   Unicorn - AWS Glue Enhancement
# Created:   30-July-2020
# Developer: Uday V
#
# Usage:   carma_option_overlay_fact_capital_flow_fee.sh   date environment
#
#==============================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="carma_option_overlay_fact_capital_flow_fee"
