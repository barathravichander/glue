#!/bin/sh
#####################################################################
# Script:    conv_avejoe_mwr_asset_class_ror_extract.sh
# Project:   Unicorn - AWS Glue Conversion
# Created:   18-Nov-2020
# Developer: Uday V
#
# Usage:   conv_avejoe_mwr_asset_class_ror_extract.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_avejoe_mwr_asset_class_ror_extract"
