#!/bin/sh
#####################################################################
# Script:  conv_cashflow_fact_capital_flow_fee_div_int_inc.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   conv_cashflow_fact_capital_flow_fee_div_int_inc.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_cashflow_fact_capital_flow_fee_div_int_inc"
