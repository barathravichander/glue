#!/bin/sh
#####################################################################
# Script:    keyrecon_fact_sor_holding.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   24-Oct-2019
# Developer: Sanjay Pancholi
#
# Usage:   keyrecon_fact_sor_holding.sh date environment
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/11/15 : kumarsuni   		:  Updated JOB_ARGUMENTS format : NA (Enhancement)
...
#Script/job name:
JOB_NAME="keyrecon_fact_sor_holding"
