#!/bin/sh
#####################################################################
# Script:    recon_aurora_fpv_export.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   10-May-2022
# Developer: Utkarsh Gupta
#
# Usage:   recon_aurora_fpv_export.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="recon_aurora_fpv_export_p"
...
ENV=$3
AWS_REGION=$4
g_MSG="BATCH_DATE=${BATCH_DATE}, TABLE_NAME=${TABLE_NAME}, ENV=${ENV}, AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--TABLE_NAME=\"$TABLE_NAME\""
