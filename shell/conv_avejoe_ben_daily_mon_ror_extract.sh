#!/bin/sh
#####################################################################
# Script:  conv_avejoe_ben_daily_mon_ror_extract.sh
# Project: Unicorn
# Created: 8-SEP-2020
# Developer: Uday V
#
# Usage:   conv_avejoe_ben_daily_mon_ror_extract.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_avejoe_ben_daily_mon_ror_extract"
