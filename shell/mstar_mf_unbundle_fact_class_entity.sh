#!/bin/sh
#####################################################################
# Script:  mstar_mf_unbundle_fact_class_entity.sh
# Project: Unicorn - AWS Glue Migration
# Created: 12-JUN-2020
# Developer: Amit Kheterpal
#
# Usage:   mstar_mf_unbundle_fact_class_entity.sh date environment AWS region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="mstar_mf_unbundle_fact_class_entity"
