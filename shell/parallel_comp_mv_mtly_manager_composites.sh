#!/bin/sh
#####################################################################
# Script:    parallel_comp_mv_mtly_manager_composites.sh
# Project:   Unicorn - AWS Glue
# Created:   08-July-2021
# Developer: Uday V
#
# Usage:   parallel_comp_mv_mtly_manager_composites.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_comp_mv_mtly_manager_composites"
