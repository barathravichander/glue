#!/bin/sh
#####################################################################
# Script:  day_zero_five29_fact_holding.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   day_zero_five29_fact_holding.sh date environment
#
#================================================================
#  Change Revision
...
#                                 updated Job Args for Glue Job
#     2022/08/17 : Vasudevan P : Added conf parameter to Glue 3.0 to fix Stream is corrupted issue  : Bug no
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="day_zero_five29_fact_holding"
