#!/bin/sh
#####################################################################
# Script:    carma_accfa_brdg_account_relation.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   07-May-2020
# Developer: Akshay Gundale
#
# Usage:   carma_accfa_brdg_account_relation.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/05/07 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="carma_accfa_brdg_account_relation"
