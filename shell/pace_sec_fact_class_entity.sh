#!/bin/sh
#####################################################################
# Script:    pace_sec_fact_class_entity.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   24-Oct-2019
# Developer: Sanjay Pancholi
#
# Usage:   pace_sec_fact_class_entity.sh date environment
#
# Usage:   rimes_fact_benchmark_ror.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/11/15 : kumarsuni : added 3rd job parameter and logging
#     2022/08/17 : Vasudevan P : Added a parameter to conf to fix date pattern issue occurred at Glue 3.0 : Bug no
#####################################################################

#Script/job name:
JOB_NAME="pace_sec_fact_class_entity"
