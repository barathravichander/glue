#!/bin/sh
#####################################################################
# Script:    rpt_composite_report.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   07-September-2021
# Developer: Akhil Joe
#
# Usage:   rpt_composite_report.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="rpt_composite_report"

echo "Executing script: ${JOB_NAME}.sh"

# Local variables
NUM_ARG=$#
REQRD_ARGUMENT_COUNT=6
...
FOA_FILE_NAME=$5
COMP_FILE_NAME=$6
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, AWS_REGION=${AWS_REGION}, FILE_TYPE=${FILE_TYPE}, FOA_FILE_NAME=${FOA_FILE_NAME}, COMP_FILE_NAME=${COMP_FILE_NAME}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--FILE_TYPE=\"$FILE_TYPE\",--FOA_FILE_NAME=\"$FOA_FILE_NAME\",--COMP_FILE_NAME=\"$COMP_FILE_NAME\""
