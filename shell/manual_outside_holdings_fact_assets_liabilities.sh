#!/bin/sh
#####################################################################
# Script:    manual_outside_holdings_fact_assets_liabilities.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   17-Dec-2020
# Developer: UDAY V
#
# Usage:   manual_outside_holdings_fact_assets_liabilities.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="manual_outside_holdings_fact_assets_liabilities"
