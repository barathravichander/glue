#!/bin/sh
#####################################################################
# Script:    toolset_account_restrictions_fact_class_entity.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Nov-2019
# Developer: Amit Kheterpal
#
# Usage:   toolset_account_restrictions_fact_class_entity.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="toolset_account_restrictions_fact_class_entity"
