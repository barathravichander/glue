#!/bin/sh
#####################################################################
# Script:    factset_fact_benchmark_ror.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   13-Nov-2019
# Developer: Barath Ravichander
#
# Usage:   factset_fact_benchmark_ror.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/11/14 : pancholis : fixed argument format : NA (Enhancement)
#     2022/08/17 : Vasudevan P : Added a parameter to conf to fix date pattern issue occurred at Glue 3.0 : Bug no
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="factset_fact_benchmark_ror"
...
#JOB_ARGUMENTS="{--BATCH_DATE='$BATCH_DATE',--ENV='$ENV'}"
CONFIG_SPARK_MEM='spark.sql.legacy.timeParserPolicy=LEGACY'
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--conf=\"$CONFIG_SPARK_MEM\""
