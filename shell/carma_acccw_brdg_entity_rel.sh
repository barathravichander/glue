#!/bin/sh
#####################################################################
# Script:    carma_acccw_brdg_entity_rel.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   15-May-2020
# Developer: Akshay Gundale
#
# Usage:   carma_acccw_brdg_entity_rel.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/05/15 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="carma_acccw_brdg_entity_rel"
