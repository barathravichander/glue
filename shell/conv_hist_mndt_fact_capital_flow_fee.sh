#!/bin/sh
#####################################################################
# Script:    conv_hist_mndt_fact_capital_flow_fee.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   11-Dec-2020
# Developer: Chirag Mota
#
# Usage:   conv_hist_mndt_fact_capital_flow_fee.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_hist_mndt_fact_capital_flow_fee"
