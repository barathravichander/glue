#!/bin/sh
#####################################################################
# Script:    conv_pacehist_dtl_program_asset.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   10-Dec-2019
# Developer: Sanjay Pancholi
#
# Usage:   conv_pacehist_dtl_program_asset.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/12/10 : pancholis : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_pacehist_dtl_program_asset"
