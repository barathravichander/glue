#!/bin/sh
#####################################################################
# Script:    acc_perf_daily_tool_cpos_acc_perf_ror.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   03-FEB-2021
# Developer: Rajalakshmi Rajagopal
#
# Usage:   acc_perf_daily_tool_cpos_acc_perf_ror.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="acc_perf_daily_tool_cpos_acc_perf_ror"
...
##Call script to execute the glue job...
