#!/bin/sh
#####################################################################
# Script:    awaccts_mtdt_asset_wizard_acc_filter.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   20-OCT-2020
# Developer: Rajalakshmi Rajagopal
#
# Usage:   awaccts_mtdt_asset_wizard_acc_filter.sh date environment aws-region
#
...
#Script/job name:
JOB_NAME="awaccts_mtdt_asset_wizard_acc_filter"
