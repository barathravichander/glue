#!/bin/sh
#####################################################################
# Script:    conv_secrtn_fact_ror_hist.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   18-Dec-2019
# Developer: Sanjay Pancholi
#
# Usage:   conv_secrtn_fact_ror_hist.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_secrtn_fact_ror_hist"
...
g_MSG="Required number of Arguments: ${REQRD_ARGUMENT_COUNT} and Not ${NUM_ARG} to ${RUN_SCRIPT} \\
      USAGE:   ${RUN_SCRIPT} batch-date environment file-type aws-region \\
...
CONFIG_SPARK_MEM='spark.yarn.executor.memoryOverhead=5G'
