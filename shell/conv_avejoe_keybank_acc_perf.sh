#!/bin/sh
####################################################################
# Script:    conv_avejoe_keybank_acc_perf.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   19-May-2020
# Developer: Akshay Gundale
#
# Usage:   conv_avejoe_keybank_acc_perf.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/05/19 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_avejoe_keybank_acc_perf"
