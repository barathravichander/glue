#!/bin/sh
#####################################################################
# Script:    conv_avejoe_account_tot_adv_slv_extracts.sh
# Project:   Unicorn - AWS Glue Conversion
# Created:   10-DEC-2020
# Developer: Uday V
#
# Usage:   conv_avejoe_account_tot_adv_slv_extracts.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_avejoe_account_tot_adv_slv_extracts"
