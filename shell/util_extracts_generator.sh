#!/bin/sh
#####################################################################
# Script:    util_extracts_generator.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   26-Dec-2019
# Developer: Chirag Mota
#
# Usage:   util_extracts_generator.sh date environment aws-region prop
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/12/26 : motac : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="util_extracts_generator"
...
AWS_REGION=$3
PROP=$4
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, AWS_REGION=${AWS_REGION}, PROP=${PROP}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--PROP=\"$PROP\""
