#!/bin/sh
#####################################################################
# Script:    lco_dim_account_link.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   04-Jun-2020
# Developer: Sanjay Pancholi
#
# Usage:   lco_dim_account_link.sh date environment aws-region
#
#================================================================
#  Change Revision
#    YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#================================================================
#    2020/06/16 : Sanjay Pancholi  : Change in name : NA
#####################################################################

#Script/job name:
JOB_NAME="lco_dim_account_link"
