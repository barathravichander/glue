#!/bin/sh
#####################################################################
# Script:    toolset_a2i_brdg_instrument_relation.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Apr-2020
# Developer: Sanjay Pancholi
#
# Usage:   toolset_a2i_brdg_instrument_relation.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="toolset_a2i_brdg_instrument_relation"
