#!/bin/sh
#####################################################################
# Script:    conv_sec_master_dim_dtl_instrument_ref.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   04-Jun-2020
# Developer: Sunil Kumar
#
# Usage:   conv_sec_master_dim_dtl_instrument_ref.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_sec_master_dim_dtl_instrument_ref"
