#!/bin/sh
####################################################################
# Script:    conv_avejoe_extracts.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   05-Aug-2020
# Developer: Rajalakshmi Rajagopal
#
# Usage:   conv_avejoe_extracts.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/04/06 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_avejoe_extracts"
