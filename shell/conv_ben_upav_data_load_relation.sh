#!/bin/sh
#####################################################################
# Script:    conv_ben_upav_data_load_relation.sh
# Project:   Unicorn - AWS Glue Conversion
# Created:   06-May-2020
# Developer: Saubhagya Baral
#
# Usage:   conv_ben_upav_data_load_relation.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_ben_upav_data_load_relation"
