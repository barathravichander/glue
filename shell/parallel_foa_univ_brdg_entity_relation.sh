#!/bin/sh
#####################################################################
# Script:  parallel_foa_univ_brdg_entity_relation.sh
# Project: Unicorn - AWS Glue Migration
# Created: 08-Oct-2021
# Developer: Ajay Konidena
#
# Usage:   parallel_foa_univ_brdg_entity_relation.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_foa_univ_brdg_entity_relation"
