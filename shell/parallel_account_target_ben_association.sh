#!/bin/sh
#####################################################################
# Script:  parallel_account_target_ben_association.sh
# Project: Unicorn - AWS Glue Migration
# Created: 23-JUL-2021
# Developer: Akhil Joe
#
# Usage:   parallel_account_target_ben_association.sh date environment AWS region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_account_target_ben_association"
