#!/bin/sh
#####################################################################
# Script:    parallel_stg_fiscal_activity_trans.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Jul-2021
# Developer: Praneeth 
#
# Usage:   parallel_stg_fiscal_activity_trans.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="parallel_stg_fiscal_activity_trans"
