#!/bin/sh
#####################################################################
# Script:  hja_stg_trans_trailer_jonr.sh
# Project: Unicorn - AWS Glue Migration
# Created: 18-Nov-2019
# Developer: Sunil Kumar
#
# Usage:   hja_stg_trans_trailer_jonr.sh date env record_type client_number aws_region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="hja_stg_trans_trailer_jonr"
