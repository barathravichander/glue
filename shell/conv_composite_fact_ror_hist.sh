#!/bin/sh
#####################################################################
# Script:    conv_composite_fact_ror_hist.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   19-Mar-2020
# Developer: Vikas Singh
#
# Usage:   conv_composite_fact_ror_hist.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2020/03/17 : singhvi : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_composite_fact_ror_hist"
