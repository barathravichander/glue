#!/bin/sh
#####################################################################
# Script:  h2b_stg_book_keeping_trans.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   h2b_stg_book_keeping_trans.sh date env record_type client_number aws_region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="h2b_stg_book_keeping_trans"
