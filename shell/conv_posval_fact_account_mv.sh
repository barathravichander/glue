#!/bin/sh
#####################################################################
# Script:    conv_posval_fact_account_mv.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   24-Oct-2019
# Developer: Vikas Singh
#
# Usage:   conv_posval_fact_account_mv.sh date environment year aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/11/13 : singhvi : enhanced for usage of common.lib : NA (Enhancement)

#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_posval_fact_account_mv"
