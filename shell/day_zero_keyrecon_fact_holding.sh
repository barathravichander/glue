#!/bin/sh
#####################################################################
# Script:  day_zero_keyrecon_fact_holding.sh
# Project: Unicorn - AWS Glue Migration
# Created: 06-Nov-2019
# Developer: Sanjay Pancholi
#
# Usage:   day_zero_keyrecon_fact_holding.sh date environment
#
#================================================================
#  Change Revision
...
#     2021/09/28 : Akhil Joe : updated account and instrumented stub args : NA (Enhancement)
#                              updated Job Args for Glue Job
...
#Script/job name:
JOB_NAME="day_zero_keyrecon_fact_holding"
