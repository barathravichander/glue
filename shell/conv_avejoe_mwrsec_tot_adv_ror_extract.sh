#!/bin/sh
####################################################################
# Script:    conv_avejoe_mwrsec_tot_adv_ror_extract.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   07-AUG-2020
# Developer: Uday V
#
# Usage:   conv_avejoe_mwrsec_tot_adv_ror_extract.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_avejoe_mwrsec_tot_adv_ror_extract"
