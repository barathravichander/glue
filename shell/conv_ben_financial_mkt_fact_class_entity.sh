#!/bin/sh
#####################################################################
# Script:    conv_ben_financial_mkt_fact_class_entity.sh
# Project:   Unicorn - AWS Glue Conversion
# Created:   31-Mar-2020
# Developer: Saubhagya Baral
#
# Usage:   conv_ben_financial_mkt_fact_class_entity.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_ben_financial_mkt_fact_class_entity"
