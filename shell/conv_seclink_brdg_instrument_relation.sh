#!/bin/sh
#####################################################################
# Script:    conv_seclink_brdg_instrument_relation.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   18-Dec-2019
# Developer: Akshay Gundale
#
# Usage:   conv_seclink_brdg_instrument_relation.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#     2019/12/18 : gundalea : script copied from existing one : NA (Enhancement)
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_seclink_brdg_instrument_relation"
