#!/bin/sh
#####################################################################
# Script:    conv_kb_uan_dtl_account_ref.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   24-Oct-2019
# Developer: Sanjay Pancholi
#
# Usage:   conv_kb_uan_dtl_account_ref.sh date environment aws-region
#
#================================================================
#  Change Revision
#     YYYY/MM/DD : <developer_name> : <Changes Made> : Bug no
#	  2019/11/14 : kumarsuni : updated for logging framework : NA (Enhancement)
#                              updated Job Args for Glue Job
#================================================================
#####################################################################

#Script/job name:
JOB_NAME="conv_kb_uan_dtl_account_ref"
