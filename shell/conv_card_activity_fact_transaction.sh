#!/bin/sh
#####################################################################
# Script:  conv_card_activity_fact_transaction.sh
# Project: Unicorn - AWS Glue Conversion
# Created: 06-OCT-2020
# Developer: Uday V
#
# Usage:   conv_card_activity_fact_transaction.sh date environment
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="conv_card_activity_fact_transaction"
