#!/bin/sh
#####################################################################
# Script:    ben_targets_mly_compare.sh
# Project:   Unicorn - AWS Glue Migration
# Created:   14-Sep-2021
# Developer: Praneeth 
#
# Usage:   ben_targets_mly_compare.sh date environment aws-region
#
#================================================================
#  Change Revision
...
#Script/job name:
JOB_NAME="ben_targets_mly_compare"
...
MONTH_BEGIN_DT=$3
AWS_REGION=$4
g_MSG="BATCH_DATE=${BATCH_DATE}, ENV=${ENV}, MONTH_BEGIN_DT=${MONTH_BEGIN_DT}, AWS_REGION=${AWS_REGION}"
echo "$g_MSG"
...
JOB_ARGUMENTS="--BATCH_DATE=\"$BATCH_DATE\",--ENV=\"$ENV\",--MONTH_BEGIN_DT=\"$MONTH_BEGIN_DT\",--conf=\"$CONFIG_SPARK_MEM\""
